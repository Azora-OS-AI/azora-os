...
async function mint100KAZR() {
  try {
    const amount = web3.utils.toWei('100000', 'ether'); // 100,000 AZR
    ...
    console.log('Minted 100,000 AZR to CEO address:', receipt.transactionHash);
    console.log('Use for company development and offices!');
  } catch (err) {
