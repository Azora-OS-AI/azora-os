...
export function MetricsPanel() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Compliance Score Trend</h3>
        <div className="h-64">
      ...
      <div className="card">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Framework Performance</h3>
      ...
      <div className="card">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Violations Breakdown</h3>
        <div className="h-64">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={[
      ...
      {/* Audit Status */}
      <div className="card">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Audit Status</h3>
